		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						<div class="lable">可约时段</div>
						<div class="text "  >{{detail.keyueshiduan}}</div>
					</div>
					<div class="item">
						<div class="lable">设施设备</div>
						<div class="text "  >{{detail.sheshishebei}}</div>
					</div>
					<div class="item">
					...
					<div class="item">
						<div class="lable">场地规约</div>
						<div class="text "  >{{detail.changdiguiyue}}</div>
					</div>
					<div class="item">
					...
					<div class="btn_box">
						...
						<el-button class="reserveBtn" 
							v-if="btnAuth('changdixinxi','预订')" 
							@click="onAcross('changdiyuding','','','changdizhuangtai','已预约','已预约,未预约'.split(',')[0])" type="warning">
							预订
						</el-button>
						<el-button class="reserveBtn" 
							v-if="btnAuth('changdixinxi','养护')" 
							@click="onAcross('changdiyanghu','','','','')" type="warning">
							养护
						</el-button>
					</div>
				</div>
			...
			<div class="detail2">
				...
				<div class="desc-text" v-html="detail.changdixiangqing"></div>
