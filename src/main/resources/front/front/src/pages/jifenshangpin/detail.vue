		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						<div class="lable">商品介绍</div>
						<div class="text "  >{{detail.shangpinjieshao}}</div>
					</div>
					<div class="item">
					...
					<div class="btn_box">
						<el-button class="editBtn" v-if="btnAuth('jifenshangpin','修改')" @click="editClick">修改</el-button>
						<el-button class="delBtn" v-if="btnAuth('jifenshangpin','删除')" @click="delClick">删除</el-button>
						<el-button class="reserveBtn" 
							v-if="btnAuth('jifenshangpin','兑换')" 
							@click="onAcross('jifenduihuan','','','','')" type="warning">
							兑换
						</el-button>
					</div>
				</div>
	...
	export default {
		...
		methods: {
			...
			async onAcross(acrossTable,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				localStorage.setItem('crossTable',`jifenshangpin`);
			...
			// 删除
			async delClick(){
				await this.$confirm('是否删除此积分商品？') .then(_ => {
