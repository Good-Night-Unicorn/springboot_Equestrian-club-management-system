<template>
	<div class="add-update-preview">
		<el-form
			...
			label-width="180px"
			>
			<el-form-item class="add-item" label="马匹名字" prop="mapimingzi">
				<el-input v-model="ruleForm.mapimingzi" 
					placeholder="马匹名字" clearable :disabled=" false  ||ro.mapimingzi"></el-input>
			</el-form-item>
			<el-form-item class="add-item"  label="马匹种类" prop="mapizhonglei">
				<el-select v-model="ruleForm.mapizhonglei" placeholder="请选择马匹种类" :disabled=" false  ||ro.mapizhonglei" >
					<el-option
			...
			<el-form-item class="add-item" label="马匹编号" prop="mapibianhao">
				<el-input v-model="ruleForm.mapibianhao" 
					placeholder="马匹编号" clearable :disabled=" false  ||ro.mapibianhao"></el-input>
			</el-form-item>
			...
			<el-form-item class="add-item"  label="马匹性别" prop="mapixingbie">
				<el-select v-model="ruleForm.mapixingbie" placeholder="请选择马匹性别" :disabled=" false  ||ro.mapixingbie" >
					<el-option
			...
			<el-form-item class="add-item"  label="身体状况" prop="shentizhuangkuang">
				<el-select v-model="ruleForm.shentizhuangkuang" placeholder="请选择身体状况" :disabled=" false  ||ro.shentizhuangkuang" >
					<el-option
			...
			<el-form-item class="add-item" label="马匹年龄" prop="mapinianling">
				<el-input v-model.number="ruleForm.mapinianling" 
					placeholder="马匹年龄" clearable :disabled=" false  ||ro.mapinianling"></el-input>
			</el-form-item>
			<el-form-item class="add-item"  label="是否接种" prop="shifoujiezhong">
				<el-select v-model="ruleForm.shifoujiezhong" placeholder="请选择是否接种" :disabled=" false  ||ro.shifoujiezhong" >
					<el-option
			...
			<el-form-item class="add-item" label="马匹性情" prop="mapixingqing">
				<el-input v-model="ruleForm.mapixingqing" 
					placeholder="马匹性情" clearable :disabled=" false  ||ro.mapixingqing"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="马匹爱好" prop="mapiaihao">
				<el-input v-model="ruleForm.mapiaihao" 
					placeholder="马匹爱好" clearable :disabled=" false  ||ro.mapiaihao"></el-input>
			</el-form-item>
			...
			<el-form-item class="add-item" label="马匹详情" prop="mapixiangqing">
				<editor 
	...
	export default {
		...
		methods: {
			...
			init(type) {
				...
				this.$http.get('option/mapizhonglei/mapizhonglei', {emulateJSON: true}).then(res => {
					if (res.data.code == 0) {
						this.mapizhongleiOptions = res.data.data;
					}
				});
			...
			// 多级联动参数
			info() {
				this.$http.get(`mapixinxi/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
					if (res.data.code == 0) {
			...
			async onSubmit() {
				await this.$refs["ruleForm"].validate(async valid => {
					if(valid) {
						...
						await this.$http.post(`mapixinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(async res => {
							if (res.data.code == 0) {
								this.$message({
									message: '操作成功',
									type: 'success',
