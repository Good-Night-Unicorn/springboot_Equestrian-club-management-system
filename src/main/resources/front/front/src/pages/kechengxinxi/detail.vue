<template>
	...
	<!--  -->
		...
		<div class="detail-preview">
				...
				<div class="info">
					...
					<div class="btn_box">
						...
						<el-button class="reserveBtn" 
							v-if="btnAuth('kechengxinxi','课程预订')" 
							@click="onAcross('kechengyuding','','','','')" type="warning">
							课程预订
						</el-button>
					</div>
				</div>
			...
			<div class="detail2">
				<div class="desc-view">
					<div class="desc-label">课程详情</div>
				</div>
				<div class="desc-text" v-html="detail.kechengxiangqing"></div>
