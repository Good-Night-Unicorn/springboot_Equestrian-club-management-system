		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						<div class="lable">菜单</div>
						<div class="text "  >{{detail.menujson}}</div>
					</div>
					<div class="btn_box">
						<el-button class="editBtn" v-if="btnAuth('menu','修改')" @click="editClick">修改</el-button>
						<el-button class="delBtn" v-if="btnAuth('menu','删除')" @click="delClick">删除</el-button>
					</div>
				</div>
			</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 删除
			async delClick(){
				await this.$confirm('是否删除此菜单？') .then(_ => {
