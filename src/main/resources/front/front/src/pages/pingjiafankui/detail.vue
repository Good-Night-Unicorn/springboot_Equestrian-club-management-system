			...
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						...
						<div class="text "  >{{detail.fankuibiaoti}}</div>
					</div>
					<div class="item">
					...
					<div class="item">
						<div class="lable">评价打分</div>
						<div class="text "  >{{detail.pingjiadafen}}</div>
					</div>
					<div class="item">
						<div class="lable">评价结果</div>
						<div class="text "  >{{detail.pingjiajieguo}}</div>
					</div>
					<div class="item">
			...
			init() {
				...
				this.$http.get(this.tablename + '/detail/'  + this.id, {}).then(res => {
					if (res.data.code == 0) {
						...
						this.detailBanner = this.detail.fankuitupian ? this.detail.fankuitupian.split(",") : [];
						this.$forceUpdate();
