<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="反馈标题" prop="fankuibiaoti">
			...
			<el-form-item class="add-item"  label="评价打分" prop="pingjiadafen">
				<el-select v-model="ruleForm.pingjiadafen" placeholder="请选择评价打分" :disabled=" false  ||ro.pingjiadafen" >
					<el-option
			...
			<el-form-item class="add-item"  label="评价结果" prop="pingjiajieguo">
				<el-select v-model="ruleForm.pingjiajieguo" placeholder="请选择评价结果" :disabled=" false  ||ro.pingjiajieguo" >
					<el-option
