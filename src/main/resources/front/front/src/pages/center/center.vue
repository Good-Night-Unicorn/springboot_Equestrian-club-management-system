<template>
	<div class="center-preview">
		...
		<div class="center-info">
			...
			<div class="img-box" v-if="userTableName=='huiyuan'">
				<img :src="sessionForm.touxiang?baseUrl + sessionForm.touxiang:require('@/assets/avator.png')">
			</div>
			<div class="img-box" v-if="userTableName=='jiaolian'">
				<img :src="sessionForm.touxiang?baseUrl + sessionForm.touxiang:require('@/assets/avator.png')">
			</div>
			<div class="img-box" v-if="userTableName=='mafang'">
				<img :src="sessionForm.touxiang?baseUrl + sessionForm.touxiang:require('@/assets/avator.png')">
			</div>
			<div class="info-item1" v-if="userTableName=='huiyuan'">
				<span class="icon iconfont "></span>
				<div class="label">会员账号：</div>
				<div class="text">{{sessionForm.huiyuanzhanghao}}</div>
			</div>
			<div class="info-item2" v-if="userTableName=='huiyuan'">
				<span class="icon iconfont "></span>
				<div class="label">会员姓名：</div>
				<div class="text">{{sessionForm.huiyuanxingming}}</div>
			</div>
			<div class="info-item3" v-if="userTableName=='huiyuan'">
				<span class="icon iconfont "></span>
				<div class="label">联系方式：</div>
				<div class="text">{{sessionForm.lianxifangshi}}</div>
			</div>
			<div class="info-item4" v-if="userTableName=='huiyuan'">
				<span class="icon iconfont "></span>
				<div class="label">性别：</div>
				<div class="text">{{sessionForm.xingbie}}</div>
			</div>
			<div class="info-item5" v-if="userTableName=='huiyuan'">
				<span class="icon iconfont "></span>
				<div class="label">年龄：</div>
				<div class="text">{{sessionForm.nianling}}</div>
			</div>
			<div class="info-item6" v-if="userTableName=='huiyuan'">
				<span class="icon iconfont "></span>
		...
		<el-tabs class="center-tabs" tab-position="left" @tab-click="handleClick">
			<el-tab-pane label="个人中心">
				<el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="180px">
					<el-form-item class="center-item" v-if="userTableName=='huiyuan'" label="会员账号" prop="huiyuanzhanghao">
						<el-input v-model="sessionForm.huiyuanzhanghao" placeholder="会员账号" readonly></el-input>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='huiyuan'" label="会员姓名" prop="huiyuanxingming">
						<el-input v-model="sessionForm.huiyuanxingming" placeholder="会员姓名" ></el-input>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='huiyuan'" label="联系方式" prop="lianxifangshi">
						<el-input v-model="sessionForm.lianxifangshi" placeholder="联系方式" ></el-input>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='huiyuan'" label="性别" prop="xingbie">
						<el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
							<el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
						</el-select>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='huiyuan'" label="年龄" prop="nianling">
						<el-input v-model="sessionForm.nianling" placeholder="年龄" ></el-input>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='huiyuan'" label="头像" prop="touxiang">
						<file-upload
							tip="点击上传头像"
							action="file/upload"
							:limit="1"
					...
					<el-form-item class="center-item" v-if="userTableName=='huiyuan'" label="积分">
...
<script>
	...
	export default {
		...
		created() {
			...
			if ('huiyuan' == this.userTableName&&this.rules['huiyuanzhanghao']){
				this.rules['huiyuanzhanghao'].push({ required: true, message: '请输入会员账号', trigger: 'blur' })
			}else if('huiyuan' == this.userTableName&&!this.rules['huiyuanzhanghao']) {
				this.$set(this.rules, 'huiyuanzhanghao', [{ required: true, message: '请输入会员账号', trigger: 'blur' }]);
			}
			if ('huiyuan' == this.userTableName&&this.rules['huiyuanxingming']){
				this.rules['huiyuanxingming'].push({ required: true, message: '请输入会员姓名', trigger: 'blur' })
			}else if('huiyuan' == this.userTableName&&!this.rules['huiyuanxingming']) {
