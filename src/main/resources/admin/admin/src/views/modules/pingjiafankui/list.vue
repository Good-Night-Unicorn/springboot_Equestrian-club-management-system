		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"alignItems":"center","padding":"10px","display":"flex"}' >
					...
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">反馈标题</label>
					...
					<el-table-column  :resizable='true' prop="fankuitupian" width="200" label="反馈图片">
						<template slot-scope="scope">
							<div v-if="scope.row.fankuitupian">
								<img v-if="scope.row.fankuitupian.substring(0,4)=='http'" :src="scope.row.fankuitupian.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.fankuitupian.split(',')[0])">
	...
	export default {
		...
		methods: {
			...
			getDataList() {
				...
				if(this.searchForm.pingjiadafen!='' && this.searchForm.pingjiadafen!=undefined){
					params['pingjiadafen'] = this.searchForm.pingjiadafen
				}
