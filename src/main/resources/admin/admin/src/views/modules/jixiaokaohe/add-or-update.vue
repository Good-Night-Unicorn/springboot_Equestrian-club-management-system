	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="教练考勤" prop="jiaoliankaoqin" >
					<el-select :disabled="ro.jiaoliankaoqin" v-model="ruleForm.jiaoliankaoqin" placeholder="请选择教练考勤" >
						<el-option
				...
				<el-form-item v-else class="input" label="教练考勤" prop="jiaoliankaoqin" >
					<el-input v-model="ruleForm.jiaoliankaoqin"
						placeholder="教练考勤" readonly></el-input>
				</el-form-item>
