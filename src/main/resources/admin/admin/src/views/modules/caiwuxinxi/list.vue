			...
			<el-form class="center-form-pv" :style='{"margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"alignItems":"center","padding":"10px","display":"flex"}' >
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">财务编号</label>
						<el-input v-model="searchForm.caiwubianhao" placeholder="财务编号" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">财务名称</label>
						<el-input v-model="searchForm.caiwumingcheng" placeholder="财务名称" @keydown.enter.native="search()" clearable></el-input>
					</div>
		...
		methods: {
			...
			getDataList() {
				...
				let params = {
 				...
 				if(this.searchForm.caiwubianhao!='' && this.searchForm.caiwubianhao!=undefined){
					params['caiwubianhao'] = '%' + this.searchForm.caiwubianhao + '%'
				}
 				if(this.searchForm.caiwumingcheng!='' && this.searchForm.caiwumingcheng!=undefined){
					params['caiwumingcheng'] = '%' + this.searchForm.caiwumingcheng + '%'
				}
