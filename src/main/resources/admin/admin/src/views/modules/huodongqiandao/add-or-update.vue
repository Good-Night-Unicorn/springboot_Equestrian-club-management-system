	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="签到人数" prop="huodongrenshu" >
					<el-input v-model.number="ruleForm.huodongrenshu" placeholder="签到人数" clearable  :readonly="ro.huodongrenshu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="签到人数" prop="huodongrenshu" >
					<el-input v-model="ruleForm.huodongrenshu" placeholder="签到人数" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="可获积分" prop="jifen" >
					<el-input-number v-model="ruleForm.jifen" placeholder="可获积分" :disabled="ro.jifen"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="可获积分" prop="jifen" >
					<el-input v-model="ruleForm.jifen" placeholder="可获积分" readonly></el-input>
				</el-form-item>
