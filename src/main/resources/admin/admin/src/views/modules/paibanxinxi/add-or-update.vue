	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="上班时间" prop="shangbanshijian" >
					<el-select :disabled="ro.shangbanshijian" v-model="ruleForm.shangbanshijian" placeholder="请选择上班时间" >
						<el-option
				...
				<el-form-item class="date" v-if="type!='info'" label="排班时间" prop="paibanshijian" >
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.paibanshijian" 
						type="date"
						:readonly="ro.paibanshijian"
						placeholder="排班时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.paibanshijian" label="排班时间" prop="paibanshijian" >
					<el-input v-model="ruleForm.paibanshijian" placeholder="排班时间" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item class="textarea" v-if="type!='info'" label="排班详情" prop="paibanxiangqing" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.paibanxiangqing" label="排班详情" prop="paibanxiangqing" >
				<span class="text">{{ruleForm.paibanxiangqing}}</span>
			</el-form-item>
