	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="私教费用" prop="sijiaofeiyong" >
					<el-input-number v-model="ruleForm.sijiaofeiyong" placeholder="私教费用" :disabled="ro.sijiaofeiyong"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="私教费用" prop="sijiaofeiyong" >
					<el-input v-model="ruleForm.sijiaofeiyong" placeholder="私教费用" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="教学经历" prop="jiaoxuejingli" >
					<el-input v-model="ruleForm.jiaoxuejingli" placeholder="教学经历" clearable  :readonly="ro.jiaoxuejingli"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="教学经历" prop="jiaoxuejingli" >
					<el-input v-model="ruleForm.jiaoxuejingli" placeholder="教学经历" readonly></el-input>
				</el-form-item>
			...
			<el-form-item class="textarea" v-if="type!='info'" label="资质证书" prop="zizhizhengshu" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="资质证书"
					v-model="ruleForm.zizhizhengshu" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.zizhizhengshu" label="资质证书" prop="zizhizhengshu" >
				<span class="text">{{ruleForm.zizhizhengshu}}</span>
			</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.gerenjianjie" label="个人简介" prop="gerenjianjie" >
				<span class="text" v-html="ruleForm.gerenjianjie"></span>
			</el-form-item>
		...
		data() {
			...
			return {
				...
				rules: {
					...
					sijiaofeiyong: [
						{ required: true, message: '私教费用不能为空', trigger: 'blur' },
					...
					jiaoxuejingli: [
						{ required: true, message: '教学经历不能为空', trigger: 'blur' },
					],
					gerenjianjie: [
					],
					gengxinshijian: [
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'){
					...
					for (var o in obj){
						...
						if(o=='jiaoxuejingli'){
							this.ruleForm.jiaoxuejingli = obj[o];
							this.ro.jiaoxuejingli = true;
							continue;
						}
						if(o=='gerenjianjie'){
			...
			jiaolianzhanghaoChange () {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						if(data.data.shanzhanglingyu){
							this.ruleForm.shanzhanglingyu = data.data.shanzhanglingyu
						}
					} else {
						this.$message.error(data.msg);
					}
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.gerenjianjie = this.ruleForm.gerenjianjie.replace(reg,'../../../springboot1eev7z37/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
